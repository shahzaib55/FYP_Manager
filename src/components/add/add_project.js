  ...
  return (
    <>
      <div className="flex flex-col pt-2 mr-20">
        ...
        <div className="flex flex-col overflow-y-scroll h-70 my-5 py-2 mx-10 bg-white shadow-lg rounded-lg scrollbar scrollbar scrollbar-thumb-rose-500 ">
                ...
                <div className=" flex flex-col w-56 justify-start">
                  ...
                  <select
                    ...
                    >
                      ...
                      <option value="CA">mobile</option>
                      <option value="FR">web & mobile</option>
                    </select>
                  </div>
                </div>
                <div className=" flex flex-col w-56 justify-start hidden">
                  <div className="flex justify-start">
                    <label
                      htmlFor="company"
                      className="block text-sm font-medium text-gray-700"
